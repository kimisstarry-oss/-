...
QT_MOC_LITERAL(1, 6, 23), // "connectionStatusChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 9), // "connected"
QT_MOC_LITERAL(4, 41, 25) // "updateConnectionAnimation"

    },
    "Title\0connectionStatusChanged\0\0connected\0"
...
void Title::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateConnectionAnimation(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Title::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Title::connectionStatusChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Title::connectionStatusChanged(bool _t1)
{
